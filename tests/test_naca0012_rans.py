...
class TestExtrusion(unittest.TestCase):
    ...
    def setUp(self):
        ...
        # Since the TE is open we close it with multiple linear segments
    ...
    def test_naca0012_rans(self, train=False):
        run_common_test(self.volumeFile, self.refFile, train)

    def train_naca0012_rans(self):
        self.test_naca0012_rans(train=True)
